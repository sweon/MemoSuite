# 📖 DailyMemo (Local Reading Tracker & Memo)
...
**DailyMemo** is a Local-first Progressive Web App (PWA) designed to track your reading progress and store your book-related memos. All data is kept securely within your own browser with threading support and seamless device-to-device synchronization.
...
1.  **Clone the repository:**
    ```bash
    git clone https://github.com/sweon/DailyMemo.git
    cd DailyMemo
    ```
