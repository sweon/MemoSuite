# 🧠 WordMemo (Local Language & Vocabulary Memory)
...
**WordMemo** is a Local-first Progressive Web App (PWA) designed to systematically log, manage, and store your vocabulary, idioms, and LLM interaction results. All data is kept securely within your own browser with threading support and seamless device-to-device synchronization.
...
- **Tags**: Instantly find logs using tags or specific sources (tag:tag or tag:source).
...
1.  **Clone the repository:**
    ```bash
    git clone https://github.com/sweon/WordMemo.git
    cd WordMemo
    ```
