...
<<<<<<< HEAD
    ...
    const isAtRoot = location.pathname === '/' || location.pathname === '' || location.pathname === '/index.html' || location.pathname === '/llmemo/' || location.pathname === '/LLMemo/';
...
=======
    ...
    const isAtRoot = location.pathname === '/' ||
        ...
        location.pathname.toLowerCase().endsWith('llmemo/') ||
        location.pathname === '';
