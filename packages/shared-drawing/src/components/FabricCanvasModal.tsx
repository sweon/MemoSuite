...
const createBackgroundPattern = (type: BackgroundType, paperColor: string, opacity: number, patternSize: number, transparent: boolean = false, bundleGap: number = 1, backgroundImage?: HTMLImageElement | HTMLCanvasElement, imageOpacity: number = 1.0, targetWidth?: number) => {
