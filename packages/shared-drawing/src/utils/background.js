...
export const calculateBackgroundColor = (type, intensity) => {
...
export const createBackgroundPattern = (type, paperColor, opacity, patternSize, transparent = false, bundleGap = 1, backgroundImage, imageOpacity = 1.0, targetWidth) => {
    ...
    if (type === 'image' && backgroundImage) {
        ...
        const imgHeight = backgroundImage.height || 100;
