 ...
 */
export const TouchDelayDraggable = ({ children, touchDelay = 1000, ...draggableProps }) => {
    ...
    return (_jsx(Draggable, { ...draggableProps, isDragDisabled: draggableProps.isDragDisabled || isDragDisabled, children: (provided, snapshot) => (_jsx("div", { ref: wrapperRef, onMouseDown: handleMouseDown, style: {
                touchAction: 'pan-y',
                display: 'contents'
