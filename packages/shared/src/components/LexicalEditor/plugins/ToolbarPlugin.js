...
import { $getSelection, $isRangeSelection, FORMAT_TEXT_COMMAND, FORMAT_ELEMENT_COMMAND, UNDO_COMMAND, REDO_COMMAND, CAN_UNDO_COMMAND, CAN_REDO_COMMAND, $createParagraphNode, CLEAR_EDITOR_COMMAND, $insertNodes, $createTextNode, INDENT_CONTENT_COMMAND, OUTDENT_CONTENT_COMMAND, $isTextNode, $isElementNode, } from "lexical";
import { $isListNode, ListNode, INSERT_CHECK_LIST_COMMAND, } from "@lexical/list";
...
import { FaCode, FaUndo, FaRedo, FaUnderline, FaLink, FaAlignCenter, FaAlignLeft, FaAlignRight, FaAlignJustify, FaTable, FaEraser, FaPalette, FaPlus, FaImage, FaCaretDown, FaChevronUp, FaChevronDown, FaRegSquare, FaClock, FaEllipsisH } from "react-icons/fa";
...
export const ToolbarButton = styled.button `
  ...
  &.is-active {
    background: ${(props) => props.theme.colors?.primary || "#007bff"}15;
