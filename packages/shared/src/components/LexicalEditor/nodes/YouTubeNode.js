...
const YouTubeComponent = React.lazy(() => import("../ui/YouTubeComponent"));
/**
...
export class YouTubeNode extends DecoratorNode {
    ...
    static importJSON(serializedNode) {
        return new YouTubeNode(serializedNode.videoId, serializedNode.startTimestamp, serializedNode.isShort, serializedNode.rawUrl);
    }
    exportJSON() {
        return {
    ...
    constructor(videoId, startTimestamp, isShort, rawUrl, key) {
        super(key);
    ...
    decorate() {
        return (_jsx(Suspense, { fallback: _jsx("div", { style: {
                    ...
                    color: '#fff',
                    margin: '1rem auto'
                }, children: "Loading..." }), children: _jsx(YouTubeComponent, { videoId: this.__videoId, startTimestamp: this.__startTimestamp, isShort: this.__isShort, nodeKey: this.getKey() }) }));
    }
    exportDOM() {
...
export function $createYouTubeNode(videoId, startTimestamp, isShort, rawUrl, key) {
