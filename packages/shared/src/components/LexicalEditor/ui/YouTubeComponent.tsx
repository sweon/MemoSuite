...
const YouTubeComponent: React.FC<YouTubeComponentProps> = ({
    ...
    const iframeSrc = `https://www.youtube.com/embed/${videoId}?autoplay=1&modestbranding=1&rel=0&playsinline=1&hl=${language}&cc_lang_pref=${language}${startTimestamp ? `&start=${startTimestamp}` : ''}`;
